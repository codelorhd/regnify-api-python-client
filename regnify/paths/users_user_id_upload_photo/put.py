...
# body param
SchemaForRequestBodyMultipartFormData = BodyUploadUserPhotoUsersUserIdUploadPhotoPut
...
SchemaFor200ResponseBodyApplicationJson = ProfileOut
...
class UploadUserPhoto(BaseApi):
    ...
    def upload_user_photo(
        ...
        return self._upload_user_photo_oapg(
            body=body,
