...
RequestOptionalHeaderParams = typing_extensions.TypedDict(
    ...
    {
        'admin-signup-token': typing.Union[AdminSignupTokenSchema, str, ],
    },
    total=False
)
...
request_header_admin_signup_token = api_client.HeaderParameter(
    name="admin-signup-token",
    style=api_client.ParameterStyle.SIMPLE,
    schema=AdminSignupTokenSchema,
)
# body param
...
class BaseApi(api_client.Api):
    ...
    def _create_user_oapg(
        ...
        for parameter in (
            request_header_admin_signup_token,
        ):
