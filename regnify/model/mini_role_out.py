...
class MiniRoleOut(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "permissions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "permissions", ], str]):
