...
class MiniUserRoleOut(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def role() -> typing.Type['MiniRoleOut']:
                return MiniRoleOut
            __annotations__ = {
                "role": role,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["role"]) -> 'MiniRoleOut': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["role"]) -> 'MiniRoleOut': ...
